    ...
    <AppLayout>
      <div className="container mx-auto p-4 md:p-6 space-y-4 md:space-y-6">
        ...
        {hasActiveSubscription === false ? (
          ...
          <TabsList className="w-full grid grid-cols-2 lg:grid-cols-4 bg-blue-50 p-1 gap-1">
            <TabsTrigger 
              value="overview" 
          ...
          <TabsContent value="overview" className="space-y-6 md:space-y-8 mt-8">
          ...
          <TabsContent value="patients" className="mt-8 pt-6">
            {isClinicManaged ? (
              <MyPatientsTab />
            ) : (
          ...
          <TabsContent value="verify" className="mt-8 pt-6">
          ...
          <TabsContent value="reports" className="mt-8 pt-6">
            {isClinicManaged ? (
              <ReportsTab />
            ) : (
