...
const LandingPage = () => {
  ...
  const [heroContent, setHeroContent] = useState<any>({
    ...
    subtitle: "Intelligent automation, seamless patient engagement, and meaningful results with HealthScribe",
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-10 max-w-3xl mx-auto leading-relaxed animate-fade-in" style={{ animationDelay: '0.2s' }}>
              Transform your healthcare practice with intelligent automation, seamless patient engagement, and meaningful results made possible by HealthScribe
            </p>
      ...
      <footer className="border-t border-border py-16 bg-card">
        <div className="container mx-auto px-6">
          ...
          <div className="pt-8 border-t border-border text-center text-sm text-muted-foreground">
            <p>© 2025 HealthScribe. All rights reserved. Empowering healthcare professionals worldwide.</p>
          </div>
        </div>
      </footer>
    </div>
