...
const PrescriptionFooter = () => {
  ...
  return (
    <footer className="prescription-footer" style={{
      ...
      <div style={{ width: "45%", position: "relative", textAlign: "left", fontSize: `${footerLeftFontSize}px`, lineHeight: "1.2" }}>
        <div
          contentEditable
          spellCheck={false}
          dangerouslySetInnerHTML={{ __html: footerLeft }}
          onBlur={(e) => setFooterLeft(e.currentTarget.innerHTML)}
          style={{ minHeight: "20px", outline: "none", textAlign: "left", lineHeight: "1.2" }}
        />
      </div>
      <div style={{ fontSize: "12px", fontWeight: 600, textAlign: "center", whiteSpace: "nowrap" }}>
        Page 1
      </div>
      <div style={{ width: "45%", position: "relative", textAlign: "right", fontSize: `${footerRightFontSize}px`, lineHeight: "1.2" }}>
        <div
          contentEditable
          spellCheck={false}
          dangerouslySetInnerHTML={{ __html: footerRight }}
          onBlur={(e) => setFooterRight(e.currentTarget.innerHTML)}
          style={{ textAlign: "right", minHeight: "20px", outline: "none", lineHeight: "1.2" }}
        />
      </div>
    </footer>
  );
